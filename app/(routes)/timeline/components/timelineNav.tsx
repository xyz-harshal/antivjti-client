...
export default function TimelineNav() {
    ...
    let [isVis,setIsVis]=useState(false)
    ...
    return (
        <div className="flex flex-row justify-between items-center my-borderCol py-3 px-4 mx-0 sm:mx-6 md:mx-12 lg:mx-24 xl:mx-36 2xl:mx-44">
            ...
            <div className="flex flex-row justify-center items-center gap-4">
                <div className="p-2 rounded-lg my-borderCol flex flex-row justify-center cursor-pointer" onClick={()=>{setIsVis(!isVis)}}>
                    <p>{isLoading?"Welcome":isVis?username:"*********"}</p>
                </div>
